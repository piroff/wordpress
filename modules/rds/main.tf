...
// RDS DB pass
resource "local_file" "master_password" {
  sensitive_content = random_password.master_password[0].result
  filename          = "credentials/db_pass"
...
module "db_subnet_group" {
  source = "./sub_modules/db_subnet_group"
...
module "db_parameter_group" {
  source = "./sub_modules/db_parameter_group"
...
module "db_option_group" {
  source = "./sub_modules/db_option_group"
...
module "db_instance" {
  source = "./sub_modules/db_instance"
